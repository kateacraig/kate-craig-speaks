	...
	<footer style="background:var(--bg);border-top:1px solid rgba(255,255,255,0.5);padding:54px 24px 40px;transition:background .45s">
		<div class="kc-foot" style="max-width:1180px;margin:0 auto;display:grid;grid-template-columns:1.4fr 1fr 1fr;gap:36px;align-items:start">
			<div>
				...
				<div class="kc-social">
					<a href="https://www.linkedin.com/in/kate-craig-tn/" target="_blank" rel="noopener" aria-label="Kate Craig on LinkedIn">
					...
					<a href="https://www.facebook.com/KateCraigTN" target="_blank" rel="noopener" aria-label="Kate Craig on Facebook">
					...
					<a href="https://www.tiktok.com/@katecraigtn" target="_blank" rel="noopener" aria-label="Kate Craig on TikTok">
					...
					<a href="https://www.instagram.com/katecraigtn/" target="_blank" rel="noopener" aria-label="Kate Craig on Instagram">
